      ...
      <ScrollReveal className="premium-project group relative min-h-[500px] overflow-hidden rounded-[10px] bg-[#2b1710] p-8 text-[#fffaf1] sm:p-10" direction="left">
        ...
        <div className="relative flex h-full flex-col">
          ...
          <div className="mt-auto">
            <h3 className="scene-drift-side max-w-2xl font-serif text-4xl font-semibold leading-[1.08] sm:text-5xl">{featured.titulo}</h3>
            ...
            <ScrollReveal key={item.id} delay={index * 120} className="premium-project group flex min-h-[238px] flex-col rounded-[10px] border border-[#d8cabb] bg-[#f6efe5]/65 p-6 hover:border-[#b57931]/60 hover:bg-[#f6efe5]" direction="right">
              <Link href={`/noticias/detalle/?slug=${item.slug}`} className="flex h-full flex-col">
                ...
                <div className="mt-6 flex-1">
                  ...
                  <h3 className="mt-3 font-serif text-2xl font-semibold leading-tight transition-colors group-hover:text-[#a66f2e]">{item.titulo}</h3>
