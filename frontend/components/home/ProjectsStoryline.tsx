          ...
          <ScrollReveal key={project.id} delay={index * 100}>
            <div className="grid grid-cols-1 items-center gap-16 md:grid-cols-12">
              ...
              <div className={`relative h-[500px] md:col-span-7 ${isReversed ? 'md:order-2' : ''}`}>
                <span
                  className="pointer-events-none absolute select-none text-[120px] font-bold leading-none opacity-20"
                  style={{
                    WebkitTextStroke: '1px #271310',
                    color: 'transparent',
                    top: '-3rem',
                    ...(isReversed ? { right: '-2rem' } : { left: '-2rem' }),
                  }}
                >
                  {chapterNum}
                </span>
