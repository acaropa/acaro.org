            ...
            <div className="flex flex-col gap-6 lg:col-span-5">
              ...
              <div className="flex flex-grow flex-col overflow-hidden rounded border border-[#d8cabb]/30 bg-[#e9e8e4]">
                ...
                <div className="relative overflow-hidden">
                  {/* Mapa de Google Maps – Presencia en Panamá Oeste */}
                  <div className="relative h-72 w-full sm:h-80">
                    <iframe
                      title="Presencia territorial de ACARO OBC – Panamá Oeste"
                      src="https://maps.google.com/maps?q=Capira,+Panam%C3%A1+Oeste,+Panama&t=k&z=11&ie=UTF8&iwloc=&output=embed"
                      className="absolute inset-0 h-full w-full border-0"
                      allowFullScreen
                      loading="lazy"
                      referrerPolicy="no-referrer-when-downgrade"
                    />
                    <span className="pointer-events-none absolute left-4 top-4 z-10 inline-flex items-center gap-2 rounded-full border border-white/30 bg-white/90 px-3 py-1 text-[10px] font-bold uppercase tracking-[0.18em] text-[#2f5d3a] shadow-sm backdrop-blur-sm">
